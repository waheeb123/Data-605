...
```{r}
# Read test.csv
test_data <- read.csv("https://raw.githubusercontent.com/waheeb123/Data-605/main/Final%20Project/house-prices-advanced-regression-techniques/test.csv")
...
Kaggle <- test_data[, c('Id', 'LotFrontage')]
